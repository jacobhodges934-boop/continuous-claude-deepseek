# Install continuous-agent for Claude Code and Codex CLI
...
Invoke-WebRequest -Uri "$BASE_URL/continuous-codex.ps1" -OutFile (Join-Path $INSTALL_DIR "continuous-codex.ps1")
...
Write-Host ""
Write-Host "Run with Claude Code:"
...
Write-Host ""
Write-Host "Run with Codex CLI:"
Write-Host "  pwsh $INSTALL_DIR\continuous-codex.ps1 --prompt 'Read docs/NEXT_TASKS.md and continue one small verified task.' --max-runs 3"
